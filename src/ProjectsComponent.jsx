...
function ProjectsComponent() {
  const projects = [
    ...
    },
    {
      ...
      description:
        "This App allows users to easily extract text from a variety of photos and PDFs, allowing them to access the content whenever it's convenient for them.",
      imgsrc: Scannerrimg,
    },
    {
    ...
    },
    {
      title: "HarGhar Gas",
      description:
        "Through the online platform HarGhar Gas, customers can easily reserve LPG gas cylinders from leading providers like Indane, Bharat Gas, and HP Gas.",
      imgsrc: Gasimg,
    },
    {
      title: "Apna Panchayath",
      description:
        "Here people can actively participate by posting their issues and peruse succinct summaries of local panchayats.",
      imgsrc: Panchimg,
    },
    {
      title: "Portfolio Website",
      description:
        "This is my website, which provides visitors with a glimpse into my professional identity. Designed to showcase my talents, experience, and adventure.",
      imgsrc: PortFolioimg,
    },
  ];
  ...
  const handleProjectHover = (event) => {
    ...
    setastronautPosition({
      ...
      left: `${left + window.scrollX + width - 120}px`,
    });
    setPinPosition({
  ...
  return (
    <div className="projects-content">
      ...
      >
        <img src={AstronautImg} alt="Rocket" className="astronaut_chotu" />
      </div>
