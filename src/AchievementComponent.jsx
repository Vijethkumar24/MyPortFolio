...
function AchievementsComponent() {
  const achievements = [
    {
      ...
      description:
        "Developed an innovative platform to showcase and recognize exceptional college projects, leading to increased visibility and engagement for student work.",
      imgsrc: TechProImg,
    },
    {
      title: "Excitedly participated in Hacktoberfest",
      description:
        "This involves contributing to open-source projects and collaborating with developers.",
      imgsrc: HacktoberfestImg,
    },
    {
      title: 'Passionately engaged in "Ideathon" an state-level competition',
      description:
        "This involves showcasing my creativity and problem-solving skills to tackle real-world challenges.",
      imgsrc: IdeathonImg,
    },
    {
      title:
        'Confidently contributed to the Idea Business Pitch event "Shristi"',
      description:
        "This event was conducted by VTU, presenting my entrepreneurial vision and passion for innovation.",
      imgsrc: ShristiImg,
    },
    {
      title: 'Gaming lead for AJIET college fest "AKAAR"',
      description:
        "This involved planning and supervising a range of gaming competitions and events to make sure that attendees had a fun and exciting time.",
      imgsrc: LeaderImg,
    },
    {
      title: "Event coordinator of BGMI and Valorant for college fest",
      description:
        "This involved planning and supervising a range of gaming competitions and events to make sure that attendees had a fun.",
      imgsrc: AKAARImg,
    },
  ];
  ...
  const handleAchievementHover = (event) => {
    ...
    setTrophyPosition({
      top: `${top + window.scrollY + height / 2 + 5}px`,
      left: `${left + window.scrollX + width - 60}px`,
    });
    setPinPosition({
